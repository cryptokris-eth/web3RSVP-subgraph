...
export function handleNewEventCreated(event: NewEventCreated): void {
  // We want to make sure that we don’t create any duplicate events with the same id, 
  //so we can try to load this event first, and if it isn’t found, we can create it and save it.
  ...
  if(newEvent == null){
    ...
    //Always make sure you are saving any changes made to an entity
    newEvent.save();
  }
}
